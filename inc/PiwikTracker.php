...
class PiwikTracker
{
     ...
     * @var string
     */
    static public $URL = 'http://www.readytogrimpe.climbing-crew.fr/piwik/';
    ...
    function __construct($idSite, $apiUrl = '')
    {
        ...
        $this->country = !empty($_SERVER['GEOIP_COUNTRY_NAME']) ? $_SERVER['GEOIP_COUNTRY_NAME'] : false;
        $this->region = !empty($_SERVER['GEOIP_REGION']) ? $_SERVER['GEOIP_REGION'] : false;
        $this->city = !empty($_SERVER['GEOIP_CITY']) ? $_SERVER['GEOIP_CITY'] : false;
        $this->lat = !empty($_SERVER['GEOIP_LATITUDE']) ? $_SERVER['GEOIP_LATITUDE'] : false;
        $this->long = !empty($_SERVER['GEOIP_LONGITUDE']) ? $_SERVER['GEOIP_LONGITUDE'] : false;
        $this->width = false;
        $this->height = false;
        $this->plugins = false;
        ...
        $this->ip = "";//!empty($_SERVER['HTTP_REMOTE_IP']) ? $_SERVER['HTTP_REMOTE_IP'] : false;
