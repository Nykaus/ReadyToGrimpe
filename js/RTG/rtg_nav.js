	...
	if (d)
	{
		...
		switch (d.mode)
		{
			...
			case	"gpx":
				...
				//ht += '<a class="btn btn-primary glyphicon glyphicon-eye-open" href="http://www.gpx-view.com/gpx.php?f='+fullBaseUrl+'gpx/'+info.value+'.gpx" target="_blank">Voir la trace</a></td>';
				break;
...
function rtg_refreshMap()
{
	...
	//var swLat =  46.172129577666816;
	//var swLng =  4.300459594726549;
	//var neLat =  46.456688511740964;
	//var neLng =  5.139540405273424;
